...
$hash = '$2y$10$u2DGWA2hm/3WJDfbEB9RIujNSBEdWKy0jKco1MpTBt2eCYBaD8.f.';
...
<div class="card text-warning  mb-3" style="width: 23rem;">
  ...
  <div class="card-body text-info bg-light">
        ...
        <button type="submit" class="btn btn-success" name="login">Login <i class="fas fa-sign-in-alt"></i></button>
        <a class="btn btn-outline-success" href="index.php">Beranda</a>
